...
activities = {
    ...
    "Basketball Club": {
        "description": "Develop basketball fundamentals and teamwork through practice and games",
    ...
    "Debate Team": {
        "description": "Build public speaking and critical thinking skills through structured debates",
